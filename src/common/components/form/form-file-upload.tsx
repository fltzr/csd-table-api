...
import FileUpload, { type FileUploadProps } from '@cloudscape-design/components/file-upload';
...
export const FormFileUpload = <T extends FieldValues>({ ...props }: FormFileUploadProps<T>) => {
  const {
    control,
    formState: { errors },
  } = useFormContext<T>();
